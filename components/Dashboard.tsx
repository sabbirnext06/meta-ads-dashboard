    ...
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden flex flex-col hover:shadow-md transition-shadow">
      ...
      >
        ...
        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition flex items-center justify-center">
          <span className="opacity-0 group-hover:opacity-100 transition bg-white/90 text-gray-800 text-xs font-medium px-3 py-1.5 rounded-full shadow">
            Click to preview
          </span>
        </div>
        ...
        {ad.creative?.object_type && (
          <span className={`absolute top-2 left-2 inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${type.color}`}>
            {type.label}
          </span>
        )}
        {/* Status badge */}
      ...
      <div className="p-3 flex flex-col flex-1 gap-2">
        ...
        <div className="mt-auto pt-2 border-t border-gray-100 flex gap-2">
          ...
          <a
            ...
            className="flex items-center justify-center px-2.5 py-1.5 rounded-lg bg-gray-100 hover:bg-blue-50 hover:text-blue-600 text-gray-500 transition"
          >
